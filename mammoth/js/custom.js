$(document).ready(function(){
  ...
  //menu clicl page move

  $(".menu_btn_li").on("click", function(e){
    e.preventDefault();
  ...
  $(window).on("scroll", function(){
    ...
    for(i=0; i< $("section").length; i++){
      if(scroll >= i*ht && scroll<ht*(i+1)){

        var main_txt =
        $("section").eq(i).find(".main_txt");
  ...
  //mousewheel page move  https://estar.tistory.com/85
...
//page 4 slide size check function
  ...
  function instaWidth(){
    ...
    var instaLength=$(".insta_li").width()*$(".insta_li").length;
    $(".insta_slide_box").width(instaWidth);
    $(".insta_slide, .insta_slide_inner").width(instaLength);
  }
